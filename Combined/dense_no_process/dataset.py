...
class Valve2DDataset(Dataset):
    ...
    Image handling:
        ...
        - NO normalization.
        - NO /255 scaling.
        - Center-crop outer pixels so all images have identical dimensions.
        - Repeat grayscale channel 3 times for DenseNet.
    """
    ...
    def __init__(
        ...
        # They are intentionally not used for image transformations.
        ...
        # ============================================================
        # DETERMINE COMMON CROP SIZE
        # ============================================================
        #
        # Find the smallest image height and width.
        # All images will then be CENTER CROPPED to this size.
        #
        # No interpolation/resizing is performed.
        # ============================================================
...
class Valve2DDataModule(
    ...
    def setup(
        ...
        print(
            f"MLP input width:    "
            f"{self.model_input_dim} "
            f"({len(train_columns)} values + "
            f"{len(train_columns)} masks)"
        )
